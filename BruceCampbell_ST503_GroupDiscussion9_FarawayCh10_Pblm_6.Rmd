...
We note that leg length is significant at a level of $\alpha=0.018$ and it has a negative association with the response.   
...
pander(data.frame(pi.width=pi[3]-pi[2]))
```
As expected our prediction interval has decresed in width. Ht is now significant at $0.07$ which is a dramatic change. We presume this is due to linear association among the predictors. 
